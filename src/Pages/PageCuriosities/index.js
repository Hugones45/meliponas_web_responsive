                ...
                >
                    <div className={styles.blockContainer}>
                        ...
                        <div className={styles.description_container} >
                            ...
                            <p><span style={{ zIndex: '10', position: 'relative' }} />Brazilian soil is home to more than 250 species of stingless bees, which play a crucial role in balancing the biomes.<span style={{ zIndex: '10', position: 'relative' }} >. Cultivating these bees not only generates income but also provides knowledge about the land and benefits the entire ecosystem's health</span></p>
                        </div>
